...
function Footer() {
  return (
    <div className="bg-[#00D094] py-6 md:py-14 space-y-7 md:px-2 px-5">
      <div className="text-center font-semibold text-[#02020280] md:text-[25px]">
        LYNAFRICK
      </div>
      ...
      <div className="flex justify-between space-x-7 px-4 md:px-28 ">
        <div className="flex flex-col items-start">
          ...
          <ul className="md:space-y-2">
            <li className="text-[#02020280] text-[11px] md:text-[15px]">
        ...
        <div className="">
          ...
          <ul className="md:space-y-2">
            ...
            <li className="text-[#02020280] text-[11px] md:text-[15px]">
              <NavLink to="">lynafrickstore@gmail.com</NavLink>
            </li>
          </ul>

          <div className="flex space-x-2 mt-2">
            <NavLink>
              <img src={FacebookLogo} alt="" className="md:w-[20px]" />
            </NavLink>
            <NavLink>
              <img src={Instagram} alt="" className="md:w-[32px]" />
            </NavLink>
            <NavLink>
              <img src={Twitter} alt="" className="md:w-[30px]" />
            </NavLink>
          </div>
        </div>
      </div>
