      ...
      <div className="flex justify-between items-center px-[16px] md:px-[94.5px] bg-gray-200 md:py-[23px]">
        <div>
          <img
            src={Layer}
            alt=""
            className="size-[12px] md:size-[30px] text-[#00D094]"
          />
        </div>
        ...
        <div>
          <ul className="hidden md:flex gap-[30px] items-center text-[#01282F]">
            ...
            <li>
              <NavLink to="/about-us" className="hover:font-semibold">
                About Us
              </NavLink>
            </li>
            <li>
              <NavLink to="/contact-us" className="hover:font-semibold">
                Contact Us
              </NavLink>
            </li>
          </ul>
        ...
        {showCart && (
          <div
            className="absolute top-16 right-10 bg-white shadow-lg w-[300px] h-[400px] z-50"
