  ...
  return (
    <>
                ...
                >
                  <div>
                    <img
                      src={item.image}
                      alt="Cart"
                      className="hidden md:flex size-12 rounded-sm cursor-pointer"
                    />
                  </div>
      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 z-10 left-1/2 right-1/2 transform -translate-x-1/2 pointer-events-none flex justify-center items-center text-[#FFFFFF] font-medium mb-[1640px] md:mb-[900px] text-[20px] md:text-[40px]">
          Shop
        </div>

        <div className="absolute inset-0 z-10 pointer-events-none top-[-1600px] md:top-2 md:bottom-[830px] left-2 text-[#FFFFFF] flex items-center justify-center  md:space-x-1 text-[8px]  md:text-[15px]">
        ...
        <div className="bg-[#C2FFEE] flex items-center justify-between px-2 md:px-7 py-1 md:py-4 h-[35px] md:h-[50px]">
          <div className=" flex items-center space-x-1  md:space-x-3 md:justify-between">
            ...
            <NavLink
              ...
              className="flex items-center text-[11px] space-x-1 md:text-[20px] md:space-x-4"
            >
              <div>
            ...
            <div className=" rounded-sm bg-[#FFFFFF] w-[120px] md:w-[300px]">
              <div className="flex items-center px-2 md:px-4 space-x-2 md:py-2">
                ...
                <input
                  type="text"
                  placeholder="Search"
                  className="md:flex-1 outline-0 placeholder:text-[12px] md:placeholder:text-[17px]"
                />
              </div>
            </div>
          </div>
        ...
        <div className="px-4 md:px-12 py-8">
          ...
          <div className="flex justify-center mt-8 space-x-1">
            <button
              ...
              className={`px-1 md:px-3 py-1 border rounded ${
