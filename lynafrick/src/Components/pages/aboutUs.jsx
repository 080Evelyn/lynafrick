    ...
    <div className="md:absolute md:top-[23px] md:right-[60px] md:z-50"> 
      ...
      <div className='flex flex-col gap-y-8'>
        ...
        <div className='flex flex-col items-center justify-center gap-7 px-6'>
          ...
          <div>
            <h1 className='text-[#000000] font-medium md:text-[40px]'>About LYNAFRICk</h1>
          </div>
          ...
          <div className='text-[10px] space-y-[8px] md:text-[15px]'>
            ...
            <p className='max-w-3xl mx-auto px-4 md:text-[15px]'>
              Welcome to Lynafrick, your one-stop destination for all your Nigerian grocery needs.
              We are passionate about making your shopping experience convenient, efficient, and, 
              above all, delicious.Our online grocery store was founded to simplify how you shop 
              for Nigerian food.We are a reliable online grocery store that focuses on Nigerian 
              food items.We pride ourselves in our high-quality packages of complete recipes rather 
              than single products to make shopping convenient and cheaper.We deliver all our packages 
              to your doorstep anywhere in Canada, the USA, the UK, and Germany aiming to bring home 
              taste away from home.
            </p>

            <p className='max-w-3xl mx-auto px-4 md:text-[15px]'>
              Our vision is to be the leading and trusted African online 
              grocery store in the Western world.
            </p>
          ...
          <div>
            <ul className='text-[10px] list-disc pl-8 md:pl-[130px] md:text-[15px]'>
              ...
              <li>We make shopping very convenient, as we deliver in packages rather than a single product.</li>
              <li>We always provide excellent customer service.</li>
              <li>We only offer quality products and nothing less.</li>
              <li>We strive to keep our prices competitive, so you can enjoy the convenience of online shopping without breaking the bank</li>
            </ul>
          </div>
          ...
          <div className='text-[10px] md:text-[15px] md:pl-[0px] space-y-[8px] pl-5 mb-[60px]'>
            ...
            <div>
              ...
              <p>We ensure quality package and delivery. So a refund is not accepted.</p>
            </div>

            <div>
              <h1 className='font-bold'>Do you accept payments through other third-party vendors such as Venmo or Cash app etc?N</h1>
