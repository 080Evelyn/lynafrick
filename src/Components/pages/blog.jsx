...
function blog() {
  ...
  const recentPostData = [
    ...
    {id: 2, image: Image2, title: 'What’s really special about Amala', date: '03 Aug 2022'},
    {id: 3, image: Image3, title: 'Foreign Salad or Abacha', date: '03 Aug 2022'},
    {id: 4, image: Image4, title: 'Why do Igbo not like Banga soup', date: '03 Aug 2022'},
    {id: 5, image: Image5, title: 'Moi Moi or Fried Plantain', date: '03 Aug 2022'}
  ];

  const topTen = [
    {image: ImageF, title: 'What are the top 10 Nigeria festivals in 2024', admin: 'Admin', date: '14 Oct 2022'},
    {image: ImageF, title: 'What are the top 10 Nigeria festivals in 2024', admin: 'Admin', date: '14 Oct 2022'},
    {image: ImageF, title: 'What are the top 10 Nigeria festivals in 2024', admin: 'Admin', date: '14 Oct 2022'},
    {image: ImageF, title: 'What are the top 10 Nigeria festivals in 2024', admin: 'Admin', date: '14 Oct 2022'},
    {image: ImageF, title: 'What are the top 10 Nigeria festivals in 2024', admin: 'Admin', date: '14 Oct 2022'},
  ...
  <div>
    ...
    <div className='flex flex-col gap-y-2 pb-14'>
      ...
      <div className='flex flex-col md:flex-row gap-7 md:gap-15 px-6 md:px-16 py-5 md:py-20'>
        ...
        <div className='md:order-2 space-y-2 md:space-y-5'>
          ...
          <div className='flex flex-col gap-3 md:gap-10'>
            <h1 className='flex  font-medium text-black text-[25px] md:text-[30px] items-center'>Recent Posts</h1>

            <div className='md:flex md:flex-col md:gap-[20px]'>
              <div><h1 className='hidden md:flex md:text-black md:text-[20px] md:font-semibold'>Categories</h1></div>
              ...
              {recentPostData.map((item, index) => (
                ...
                key={index}>
                  ...
                  <div className='flex flex-col w-[160px] gap-y-5 justify-center'>
                    <div className='text-[12px] md:text-[15px] font-bold leading-3 md:leading-5'>{item.title}</div>
                    <div className='text-[10px] md:text-[15px] md:text-[#9F9F9F] '>{item.date}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className='md:order-1 md:space-y-7'>
          ...
          <div>
            ...
            <p className='max-w-3xl text-[10px] text-[#9F9F9F] md:text-[15px]'>
              Nigeria has always been a nation rich in splendid culture, vast land, hassling spirit, 
              natural resources, vibrant music and art scenes, and a very yummy and nutritious meal 
              that can never be forgotten once tasted. Exploring Nigeria is not just an adventure; 
              it's a journey through a land of boundless possibilities and unending discovery. 
              With over 250 tribes, diverse delicacies are served and best enjoyed with friends and family.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='max-w-3xl text-[10px] text-[#9F9F9F] md:text-[15px]'>
              In a world that's more connected than ever, it's no surprise that many of us find ourselves 
              living far from the places we call home. For diasporas around the world, the yearning for the 
              tastes and flavours of their native land can be a constant companion. Fortunately, the digital 
              age has brought a solution to this homesickness. Online grocery stores catering to diasporas 
              have become the bridge that connects these far-flung communities with their culinary heritage. 
              Making a difference in convenience, delivery to your doorstep, community engagement, diverse 
              selection and cultural connection. So wherever you are embrace your roots, savour the flavours, 
              and make every meal a celebration of the diverse and vibrant cultures that make up our global 
              community. These online grocery stores for diasporas are more than just shopping destinations; 
              they are a testament to the power of food to unite, heal, and connect us with our heritage, 
          ...
          <div>
            ...
            <div>
              ...
              <p className='max-w-3xl text-[10px] text-[#9F9F9F] md:text-[15px]'>
                Melon seed(Egusi), palm oil, crayfish, castor seed (okpei), pepper, stockfish, dry fish, 
                seasoning, pumpkin leaves (ugu), salt, and meat.
              </p>
              ...
              <p className='max-w-3xl text-[10px] text-[#9F9F9F] md:text-[15px]'>
                Ogbono, palm oil, crayfish, castor seed (okpei), pepper, stockfish, dry fish, 
                seasoning, pumpkin leaves (ugu), salt, and meat
              </p>
              ...
              <p className='max-w-3xl text-[10px] text-[#9F9F9F] md:text-[15px]'>
                Ofada rice, fresh pepper, palm oil, onions, locust beans, seasoning, 
                salt, dry fish, and meat
              </p>
              ...
              <p className='max-w-3xl text-[10px] text-[#9F9F9F] md:text-[15px]'>
                Waterleaf, palm oil, crayfish, dry fish, stock fish, pepper, seasoning, salt, 
                okazi leaf (wild spinach), meat
              </p>
              ...
              <p className='max-w-3xl text-[10px] text-[#9F9F9F] md:text-[15px]'>              
                Pumpkin leaf (ugu), water leaf, palm oil, crayfish, pepper, seasoning, salt, stockfish, 
                dry fish, and meat.  
              </p>
              ...
              <p className='max-w-3xl text-[10px] text-[#9F9F9F] md:text-[15px]'>              
                Rice, groundnut oil, tomatoes, pepper, spices, seasoning, bay leaf, salt, ginger & garlic.
              </p>
                ...
                {topTen.map((item, index) => (
                  ...
                  key={index}>
                    ...
                    <div className='flex space-x-4'>
                      <div className='flex items-center gap-x-2 text-[#9F9F9F] text-[13px]'><img src={Profile} alt="" />{item.admin}</div>
                      <div className='flex items-center gap-x-2 text-[#9F9F9F] text-[13px]'><img src={DateIcon} alt="" />{item.date}</div>
                    </div>
                    ...
                    <div>
                      <p className='max-w-3xl text-[10px] text-[#9F9F9F] md:text-[15px]'>              
                        Nigeria is a country known for its vibrant culture, rich history, and diverse traditions. 
                        One of the best ways to experience this fascinating country is through its festivals, which 
                        showcase the unique and colourful aspects of Nigerian life. 
                      </p>
                    </div>
      ...
      <div className='flex justify-center items-center'>
        <Button className='cursor-pointer font-extrabold'> 
          See More
        </Button>
      </div>
    </div>
